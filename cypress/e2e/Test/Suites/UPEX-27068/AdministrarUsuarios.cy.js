describe('Administrar Usuarios (ESS) en el sistema de gestión de una empresa de forma básica', () => {
    ...
    it.only('US-27068 | TS-27076 | TC1: Validar que administrador pueda registrar con datos validos', () => {
    ...
    it('US-27068 | TS-27076 | TC4: Validar administrador encuentre un empleado especifico a traves del buscador', () => {});
